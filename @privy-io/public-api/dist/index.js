...
const $cd63f1af6df0c007$export$1d53282181ae94da = (0, $3z62d$z).object({
  mode: (0, $3z62d$z).enum(["no-signup", "login-or-sign-up"]).optional()
});
...
}) /* eslint-disable-next-line @typescript-eslint/naming-convention */.transform(({
  app_id: app_id
}) => ({
  app_id: app_id,
  appId: app_id
...
const $2764b54e10251e85$var$SUPPORTED_CHAIN_TYPES = ["evm", "solana"];
const $2764b54e10251e85$export$b733e092f9f44b2c = (0, $3z62d$zod).object({
  ...
  */
  ...
  // Currency asset
  asset: (0, $3z62d$zod).enum(["native-currency", "USDC"]).optional()
});
const $517ac5899dfbdcfa$export$95372738a64f3b79 = (0, $3z62d$zod).object({
  ...
  */
  create_on_login: (0, $3z62d$zod).enum(["users-without-wallets", "all-users", "off"]),
  /**
  ...
  */
  user_owned_recovery_options: (0, $3z62d$zod).array((0, $3z62d$zod).enum(["user-passcode", "google-drive", "icloud"])),
  /**
...
const $517ac5899dfbdcfa$export$fe80bb11c98cc392 = (0, $3z62d$zod).enum(["moonpay", "coinbase-onramp", "external"]);
...
const $164ad09aa405585d$export$dc5469a0fff5641e = (0, $3z62d$z).object({
  ...
  mfa_methods: (0, $3z62d$z).array((0, $3z62d$z).enum(["sms", "totp", "passkey"])),
...
const $81a8385d5b29682b$var$Blockchain = (0, $3z62d$z).enum(["ethereum", "bitcoin", "base", "avacchain", "optimism", "solana", "polygon", "arbitrum", "stellar"]);
...
const $81a8385d5b29682b$var$EthereumAssets = (0, $3z62d$z).enum(["eth", "ETH", "USDC"]).transform(asset => asset.toUpperCase());
const $81a8385d5b29682b$var$SolanaAssets = (0, $3z62d$z).enum(["SOL", "USDC"]).transform(asset => asset.toUpperCase());
...
const $81a8385d5b29682b$export$f01d538aa036a41a = (0, $3z62d$z).union([$81a8385d5b29682b$var$CoinbaseOnRampInitEthereumInput, $81a8385d5b29682b$var$CoinbaseOnRampInitSolanaInput]);
...
const $81a8385d5b29682b$export$146ab3c80d47ce12 = (0, $3z62d$z).object({
  status: (0, $3z62d$z).enum(["pending", "success", "failure"])
});
...
const $0a2bfa4af4eefcd7$export$5b3e61549b992e7e = (0, $3z62d$z).object({
  ...
  delegated_addresses: (0, $3z62d$z).array((0, $3z62d$z).object({
    chain_type: (0, $3z62d$z).union([(0, $3z62d$z).literal("solana"), (0, $3z62d$z).literal("ethereum")]),
...
const $3d02fb74c61c9f4e$export$d3aaee921473d84f = (0, $3z62d$z).object({
  ...
  use: (0, $3z62d$z).enum(["sig", "enc"]).optional(),
  key_ops: (0, $3z62d$z).array((0, $3z62d$z).enum(["sign", "verify", "encrypt", "decrypt", "wrapKey", "unwrapKey", "deriveKey", "deriveBits"])).optional(),
  alg: (0, $3z62d$z).enum(["RS256", "ES256"]),
...
const $76c1f4ed95029183$export$809802d572486db = (0, $3z62d$z).object({
  ...
  ed25519_public_key: (0, $3z62d$z).string().refine(key => key.startsWith("0x") && key.length === 66),
  /**
...
const $76c1f4ed95029183$export$327461233dec5bf6 = (0, $3z62d$z).discriminatedUnion("status", [(0, $3z62d$z).object({
...
const $76c1f4ed95029183$export$2a58492abd647af5 = (0, $3z62d$z).discriminatedUnion("status", [(0, $3z62d$z).object({
  /** The public key reflected back from the API
  * ie 0x2087e48968ca16a8954d0da041de84b66392b2821c2af42bc28aa079bcbe1dfe
  */
  public_key: (0, $3z62d$z).string(),
...
const $af5265fd3dba53f1$export$9a0b8cb5335f5046 = [$af5265fd3dba53f1$export$467c4d345d20536b, $af5265fd3dba53f1$export$5a7fd86629827df3, $af5265fd3dba53f1$export$96c76464f555e39d, $af5265fd3dba53f1$export$619884a26e96e55d, $af5265fd3dba53f1$export$404e03620b321d9e];
...
const $1aadd0fe5ffa17b5$export$721df9a9735783ee = (0, $3z62d$z).discriminatedUnion("enabled", [(0, $3z62d$z).object({
...
const $1aadd0fe5ffa17b5$export$8501bbb82f9b8fbb = (0, $3z62d$z).discriminatedUnion("enabled", [(0, $3z62d$z).object({
  enabled: (0, $3z62d$z).literal(false)
}), (0, $3z62d$z).object({
  enabled: (0, $3z62d$z).literal(true),
  smart_wallet_type: $1aadd0fe5ffa17b5$export$96b3537f43197348,
...
const $d8cf89bca885903a$export$16168ca1ad2afd69 = (0, $3z62d$z).object({
  type: (0, $3z62d$z).enum(["wallet", "smart_wallet"]),
  address: (0, $3z62d$z).string(),
  chain_type: (0, $3z62d$z).enum(["solana", "ethereum"])
});
...
const $d8cf89bca885903a$var$RecoveryMethod = (0, $3z62d$z).enum(["privy", "user-passcode", "google-drive", "icloud"]);
...
const $d8cf89bca885903a$export$70ab2a322f92399 = (0, $3z62d$z).union([$d8cf89bca885903a$export$b291b2a8281f162e, $d8cf89bca885903a$export$e461068a75eb0fb3, $d8cf89bca885903a$export$e72ed3751242ab66, $d8cf89bca885903a$export$d08a38b431a135bc, $d8cf89bca885903a$export$9847d582941f64b6, $d8cf89bca885903a$export$42e79fc33a58a2f5, $d8cf89bca885903a$export$734c44f2e990ba65, $d8cf89bca885903a$export$c05834be0df10117, $d8cf89bca885903a$export$4d795c7186f7e1f1, $d8cf89bca885903a$export$ab3c40bebc4d6f36, $d8cf89bca885903a$export$31cc32c7bc65c2e0, $d8cf89bca885903a$export$cb35596f96141125, $d8cf89bca885903a$export$55430b29b82d98a8, $d8cf89bca885903a$export$260592be4b1062f4, $d8cf89bca885903a$export$c683d35f732c1912, $d8cf89bca885903a$export$5e8143c3f32ac816, $d8cf89bca885903a$export$25b982740d2e431c, $d8cf89bca885903a$export$67af8a2e34850611, $d8cf89bca885903a$export$5da87a1cf22b57d0, $d8cf89bca885903a$export$70b11e99555e84cb, $d8cf89bca885903a$export$c7ead6bbfb2c42a0, $d8cf89bca885903a$export$70ddd50daefc295f, $d8cf89bca885903a$export$564035ac82295c40]);
...
const $d8cf89bca885903a$export$7d2a870b119c9ff4 = (0, $3z62d$z).union([$d8cf89bca885903a$export$3250154351927c42, $d8cf89bca885903a$export$27837b14d6717da8, $d8cf89bca885903a$export$dd0fcfda522da705]);
const $d8cf89bca885903a$export$58677eb7a73b7d5a = (0, $3z62d$z).record((0, $3z62d$z).string(), (0, $3z62d$z).union([(0, $3z62d$z).string(), (0, $3z62d$z).number(), (0, $3z62d$z).boolean()]));
...
const $d8cf89bca885903a$export$bbd8e1b014079dc1 = (0, $3z62d$z).enum(["set", "ignore", "clear"]);
...
const $d8cf89bca885903a$export$2b6251d563a4e626 = (0, $3z62d$z).union([$d8cf89bca885903a$export$7de20aee312d6767, $d8cf89bca885903a$export$8339543958fe900f]);
...
}).extend($619c9ebe0c9955fa$var$latestVerifiedAt).transform(({
...
const $eaaefcff8b45215e$export$5f85d1e59e4b8093 = (0, $3z62d$zod).union([$eaaefcff8b45215e$var$MfaSmsInitVerifyInput, $eaaefcff8b45215e$var$MfaSmsInitEnrollInput]);
...
const $743ea2550daa8de4$var$PaymentMethod = (0, $3z62d$z).enum(["ach_bank_transfer", "credit_debit_card", "gbp_bank_transfer", "gbp_open_banking_payment", "mobile_wallet", "sepa_bank_transfer", "sepa_open_banking_payment", "pix_instant_payment", "yellow_card_bank_transfer"]);
// Adapted from Moonpay's exact currency codes
const $743ea2550daa8de4$var$CurrencyCode = (0, $3z62d$z).enum(["AVAX_CCHAIN", "CELO_CELO", "CUSD_CELO", "DAI_ETHEREUM", "ETH_ETHEREUM", "ETH_ARBITRUM", "ETH_OPTIMISM", "ETH_POLYGON", "ETH_BASE", "FIL_FVM", "MATIC_ETHEREUM", "MATIC_POLYGON", "USDC_ETHEREUM", "USDC_ARBITRUM", "USDC_OPTIMISM", "USDC_POLYGON", "USDC_BASE", "USDT_ETHEREUM", "USDT_POLYGON", "WETH_POLYGON", "WBTC_ETHEREUM", "BNB_BNB", "BNB_BSC",
// Transformed Privy Currency Codes
"CELO", "CUSD", "DAI", "ETH", "FIL", "MATIC", "USDC", "USDT", "WETH", "WBTC"]);
const $743ea2550daa8de4$var$MoonpayFiatOnRampConfigInput = (0, $3z62d$z).object({
  ...
  uiConfig: (0, $3z62d$z).object({
    ...
    theme: (0, $3z62d$z).enum(["light", "dark"]).optional()
  }).optional()
});
...
const $743ea2550daa8de4$var$MoonpayFiatOnRampSolanaInput = (0, $3z62d$z).object({
  ...
  config: $743ea2550daa8de4$var$MoonpayFiatOnRampConfigInput.extend({
    // eslint-disable-next-line @typescript-eslint/naming-convention
    currencyCode: (0, $3z62d$z).enum(["SOL", "USDC_SOL"]).optional()
  })
});
const $743ea2550daa8de4$export$6c475a9528377d79 = (0, $3z62d$z).union([$743ea2550daa8de4$var$MoonpayFiatOnRampEthereumInput, $743ea2550daa8de4$var$MoonpayFiatOnRampSolanaInput]).and((0, $3z62d$z).object({
  // eslint-disable-next-line @typescript-eslint/naming-convention
...
const $cc5a4e53c1cd130b$export$b5266d2768e29008 = ["google", "discord", "twitter", "github", "spotify", "instagram", "tiktok", "linkedin", "apple"];
...
const $a1655510be3aa817$export$96d4e4cf27d59030 = $a1655510be3aa817$export$16a6de659e03cb8c.or((0, $3z62d$z).custom(value => {
  if (typeof value === "string") {
    return /^privy:[a-z0-9]{25}$/i.test(value);
  } else {
    return false;
  }
}, {
...
const $a1655510be3aa817$export$3a815e8ae7821b6e = (0, $3z62d$z).object({
  ...
  code_type: (0, $3z62d$z).enum(["raw"]).optional()
...
const $e64ead081b284a70$export$caca141f74b70633 = (0, $3z62d$z).enum(["ALLOW", "DENY"]);
const $e64ead081b284a70$export$fcea0b2db26e6b18 = (0, $3z62d$z).object({
  /** The field's source (e.g. ethereum_transaction) */field_source: (0, $3z62d$z).enum(["ethereum_transaction"]),
  /** The field to compare in the condition */field: (0, $3z62d$z).literal("to"),
  /** The operator to use */operator: (0, $3z62d$z).union([(0, $3z62d$z).literal("eq"), (0, $3z62d$z).literal("in")]),
  /** The value to compare */value: (0, $3z62d$z).union([(0, $3z62d$z).string(), (0, $3z62d$z).array((0, $3z62d$z).string())])
...
const $e64ead081b284a70$var$PolicyMethod = (0, $3z62d$z).union([(0, $3z62d$z).literal("eth_sendTransaction"), (0, $3z62d$z).literal("eth_signTransaction")]);
...
const $e64ead081b284a70$export$40ee6f678dc3fb2e = $e64ead081b284a70$export$c245a5cc5068498.superRefine((bp, ctx) => {
  ...
  if (methodSet.size !== bp.method_rules.length) {
    ctx.addIssue({
      path: ["method_rules"],
      code: (0, $3z62d$z).ZodIssueCode.custom,
  ...
  for (const methodRule of bp.method_rules) {
    for (const rule of methodRule.rules) {
      for (const condition of rule.conditions) {
        switch (condition.field_source) {
          case "ethereum_transaction":
            ...
            if (condition.field === "to") {
              if (condition.operator === "eq" && typeof condition.value === "string") {
                // Normalize a singular ethereum address
...
const $8c18f111dab342b1$export$52cacd413024ecd = (0, $3z62d$z).object({
  recovery_type: (0, $3z62d$z).enum(["user_passcode_derived_recovery_key", "privy_passcode_derived_recovery_key", "privy_generated_recovery_key", "google_drive_recovery_secret", "icloud_recovery_secret"]),
...
0;
const $8c18f111dab342b1$export$ea90bf451d6cb856 = $fdca613bd10859b9$export$2441567ff18621e0;
...
const $81e03de001ba4005$export$1bbb8302b8922d52 = (0, $3z62d$z).object({
  ...
  /* eslint-disable-next-line @typescript-eslint/naming-convention */
  phoneNumber: (0, $cd63f1af6df0c007$export$3d623a7758cab61e).catch(() => {
...
const $81e03de001ba4005$export$63fc94c9f0d4eea8 = (0, $3z62d$z).object({
  // Not a mistake, it's actually camelCase
  /* eslint-disable-next-line @typescript-eslint/naming-convention */
  phoneNumber: (0, $cd63f1af6df0c007$export$3d623a7758cab61e)
});
...
const $a3f3fb49e367cffa$export$3e5f628c87c944ea = (0, $3z62d$z).string().regex(
// regex from the spec https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md#specification
...
const $a3f3fb49e367cffa$export$e00d5c89c01be30a = (0, $3z62d$z).enum(["root", "manager"]).nullable();
...
const $a3f3fb49e367cffa$var$Quantity = (0, $3z62d$z).union([$a3f3fb49e367cffa$var$Hex, (0, $3z62d$z).number()]);
const $a3f3fb49e367cffa$export$4dd5c56c048ca51c = (0, $3z62d$z).object({
  ...
  /** (optional) The EIP-2718 transction type (e.g. `2` for EIP-1559 transactions). */type: (0, $3z62d$z).union([(0, $3z62d$z).literal(0), (0, $3z62d$z).literal(1), (0, $3z62d$z).literal(2)]).optional(),
...
const $a3f3fb49e367cffa$export$47e0aa7143de6eba = (0, $3z62d$z).object({
  /** Message to sign with the wallet. Must be encoded per the scheme in `encoding`. */message: (0, $3z62d$z).string(),
  /** Encoding scheme for the message (utf-8 for plaintext, hex for raw bytes). */encoding: (0, $3z62d$z).union([(0, $3z62d$z).literal("utf-8"), (0, $3z62d$z).literal("hex")])
});
...
const $a3f3fb49e367cffa$export$86729abbdf3cb00d = (0, $3z62d$z).discriminatedUnion("method", [$a3f3fb49e367cffa$export$6d6b46e54d62b80f, $a3f3fb49e367cffa$export$6a1a144657f01857, $a3f3fb49e367cffa$export$b1c3bd1406731d97, $a3f3fb49e367cffa$export$c4aa7e4bbb51693f]);
const $a3f3fb49e367cffa$export$56c132d7290bb7ea = (0, $3z62d$z).discriminatedUnion("method", [$a3f3fb49e367cffa$export$8e148d8e0fa27f14, $a3f3fb49e367cffa$export$9b59b888d99d2b7, $a3f3fb49e367cffa$export$97fa15d15442509a]);
const $a3f3fb49e367cffa$export$a965e12848db29a7 = (0, $3z62d$z).union([$a3f3fb49e367cffa$export$86729abbdf3cb00d, $a3f3fb49e367cffa$export$56c132d7290bb7ea]);
...
const $a3f3fb49e367cffa$export$e53e6185409931b0 = (0, $3z62d$z).discriminatedUnion("method", [$a3f3fb49e367cffa$export$310e1d354b294aac, $a3f3fb49e367cffa$export$1aae029e61aa62e3, $a3f3fb49e367cffa$export$261cb1d601edd7b1, $a3f3fb49e367cffa$export$2f7b6ef5cdff0e98, $a3f3fb49e367cffa$export$c62c1852c4cb6e04, $a3f3fb49e367cffa$export$f31262cd6c9b0637, $a3f3fb49e367cffa$export$21a19a0ce9a88106]);
...
const $a3f3fb49e367cffa$var$ChainTypes = (0, $3z62d$z).union([(0, $3z62d$z).literal("solana"), (0, $3z62d$z).literal("ethereum")]);
...
const $a3f3fb49e367cffa$export$df3cb5ed53755486 = (0, $3z62d$z).object({
  ...
  if (input.authorization_key_ids) {
    ctx.addIssue({
      code: "custom",
  ...
  if (input.authorization_threshold) {
    ctx.addIssue({
      code: "custom",

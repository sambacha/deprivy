...
import { CustomLandingScreenView as m } from "./CustomLandingScreenView.mjs";
import { LandingScreenView as s } from "./LandingScreenView.mjs";
import "react";
...
import "./FarcasterButton.mjs";
import "../../svg/farcaster.mjs";
import "./PasskeyLink.mjs";
import "./SmsButton.mjs";
...
import "./TelegramButton.mjs";
import "../../svg/telegram.mjs";
import "./WalletButtonList.mjs";
...
import "./Web2OverflowButton.mjs";
import "@heroicons/react/24/outline/ChevronRightIcon";
import "../../svg/email-or-phone.mjs";
import "./WalletOverflowButton.mjs";
const i = () => {
  let {
    app: i
  } = t();
  if (i.loginMethodsAndOrder && i.loginMethodsAndOrder.primary.length > 0) {
    return /*#__PURE__*/o(m, {
      connectOnly: true
    });
  } else {
...
export { i as ConnectOrCreateScreen };

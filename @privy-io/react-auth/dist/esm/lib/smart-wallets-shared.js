...
import { http as o } from "viem";
import { toCoinbaseSmartAccount as a, entryPoint06Address as c, entryPoint07Address as l } from "viem/account-abstraction";
import { COINBASE_SMART_WALLET as p, LIGHT_ACCOUNT as m, BICONOMY as u, KERNEL as y, SAFE as d } from "@privy-io/js-sdk-core";
let w = {
  address: c,
  version: "0.6"
};
...
const h = async ({
  ...
  return e({
    ...
    paymaster: u,
    paymasterContext: l,
    bundlerTransport: o(a),
    userOperation: {
      estimateFeesPerGas: async () => {
        if (f.some(e => a.includes(e))) {
          return await m.getUserOperationGasPrice().then(e => e.fast);
        }
        {
          let e = await i.estimateFeesPerGas();
          let r = a.includes("api.developer.coinbase.com") ? 175n : 150n;
          return {
            ...e,
